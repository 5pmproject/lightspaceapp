...
function Footer() {
  return (
    <div
      ...
      data-name="Footer"
    >
      <div className="absolute flex flex-col font-['Inter:Regular',_sans-serif] font-normal justify-center leading-[0] left-6 not-italic text-[#E07B39] text-[14px] text-left text-nowrap top-[94px] tracking-[-0.14px] translate-y-[-50%]">
        <BackgroundImage46
          additionalClassNames={["leading-[24px]", "whitespace-pre"]}
        >
          <span className="font-['Inter:Bold',_sans-serif] font-bold not-italic text-[#E07B39]">{`Hooray! `}</span>
...
export default function MyBasket() {
  return (
    <div className="bg-[#ffffff] relative size-full" data-name="My Basket">
      ...
      <div
        className="absolute flex flex-col font-['Inter:Regular',_sans-serif] font-normal justify-center leading-[0] not-italic text-[#E07B39] text-[18px] text-nowrap text-right top-[518px] translate-x-[-100%] translate-y-[-50%]"
