...
function BackgroundImage1({
  ...
  return (
    ...
    >
      ...
      <span className="text-[#E07B39]">{text1}</span>
    </BackgroundImage78>
  );
}
    ...
    <div className="bg-[#ffffff] h-[88px] relative shrink-0 w-[327px]">
      ...
      <div className="absolute flex flex-col font-['Inter:Regular',_sans-serif] font-normal justify-center leading-[0] left-[86px] not-italic text-[#000000] text-[14px] text-left top-4 translate-y-[-50%] w-[173px]">
        <p className="leading-[16px]">
          ...
          <span className="text-[#E07B39]">₩0.64/lb</span>
        </p>
      </div>
...
function Confirmation() {
  return (
    ...
    >
      ...
      <ConfirmationBackgroundImage
        additionalClassNames={["css-rvg814", "text-[#E07B39]", "top-[617px]"]}
      >{`$  0.75`}</ConfirmationBackgroundImage>
      <div
        className="absolute css-rvg814 flex flex-col font-['Inter:Bold',_sans-serif] font-bold justify-center leading-[0] not-italic text-[#E07B39] text-[18px] text-nowrap text-right top-[656px] translate-x-[-100%] translate-y-[-50%]"
        style={{ left: "calc(50% + 163.5px)" }}
      >
...
function Footer() {
  return (
    ...
    >
      <Button />
      <div className="absolute flex flex-col font-['Inter:Regular',_sans-serif] font-normal justify-center leading-[0] left-6 not-italic opacity-[0.001] text-[#E07B39] text-[14px] text-left text-nowrap top-[94px] tracking-[-0.14px] translate-y-[-50%]">
        <BackgroundImage78
          additionalClassNames={["leading-[24px]", "whitespace-pre"]}
        >
          <span className="font-['Inter:Bold',_sans-serif] font-bold not-italic text-[#E07B39]">{`Note: `}</span>
...
function Badge() {
  return (
    <div
      className="absolute bg-[#E07B39] left-[17px] rounded-lg size-4 top-[-1px]"
      data-name="Badge"
    >
  ...
  return (
    <div className="relative shrink-0 w-full" data-name="Sub nav">
      <div className="box-border content-stretch flex flex-row font-normal items-center justify-start leading-[0] p-0 relative text-left w-full">
        ...
        <button className="[white-space-collapse:collapse] cursor-pointer flex flex-col font-['Inter:Regular',_sans-serif] justify-center not-italic relative shrink-0 text-[#E07B39] text-[14px] text-nowrap tracking-[-0.14px]">
