          ...
          <div className="absolute left-0 right-0 top-[149px] bottom-[124px] overflow-y-auto">
            <div className="px-6 pt-[38px]">
              ...
              <div className="flex justify-between items-center">
                ...
                <div className="flex flex-col font-['Inter:Regular',_sans-serif] font-normal justify-center leading-[0] not-italic text-[#E07B39] text-[18px] text-nowrap text-right">
        ...
        <div className="box-border content-stretch flex flex-col gap-4 items-start justify-start p-6 relative w-[327px]">
          ...
          <div className="font-['Inter:Regular',_sans-serif] font-normal leading-[0] not-italic relative shrink-0 text-[#000000] text-[16px] text-left w-full">
            <p className="block leading-[1.5]">
              상품 페이지로 돌아가서 신선한 제품을 둘러보세요 🌸
            </p>
          </div>
          <button 
            onClick={onReturnToShop}
            className="bg-[#E07B39] relative rounded-[360px] shrink-0 w-full"
          >
    ...
    <div className="absolute bg-[#ffffff] bottom-0 h-[124px] left-0 overflow-clip right-0 shadow-[0px_0px_20px_0px_rgba(0,0,0,0.1)]">
      <div className="absolute flex flex-col font-['Inter:Regular',_sans-serif] font-normal justify-center leading-[0] left-6 not-italic text-[#E07B39] text-[14px] text-left text-nowrap top-[94px] tracking-[-0.14px] translate-y-[-50%]">
        <p className="leading-[24px] whitespace-pre">
          <span className="font-['Inter:Bold',_sans-serif] font-bold not-italic text-[#E07B39]">무료 배송 </span>
          <span className="adjustLetterSpacing text-[#757575]">대상입니다!</span>
        </p>
      </div>
