        ...
        <div className="mt-[34px]">
          ...
          <div className="flex justify-between items-center">
            <div className="flex flex-col font-['Inter:Bold',_sans-serif] font-bold justify-center leading-[0] not-italic text-[#000000] text-[18px] text-left text-nowrap">
              <p className="block leading-[1.45] whitespace-pre text-[18px] font-bold text-[18px]">합계</p>
            </div>
            <div className="flex flex-col font-['Inter:Bold',_sans-serif] font-bold justify-center leading-[0] not-italic text-[#E07B39] text-[18px] text-nowrap text-right">
    ...
    <div className="bg-[#ffffff] h-[88px] relative shrink-0 w-[327px]">
      ...
      <div className="absolute flex flex-col font-['Inter:Regular',_sans-serif] font-normal justify-center leading-[0] left-[86px] not-italic text-[#000000] text-[14px] text-left top-4 translate-y-[-50%] w-[173px]">
        <p className="leading-[16px]">
          ...
          <span className="text-[#E07B39]">{item.price}</span>
        </p>
      </div>
    ...
    <div className="absolute bg-[#ffffff] bottom-0 h-[124px] left-0 overflow-clip right-0 shadow-[0px_0px_20px_0px_rgba(0,0,0,0.1)]">
      ...
      <div className="absolute flex flex-col font-['Inter:Regular',_sans-serif] font-normal justify-center leading-[0] left-6 not-italic opacity-[0.001] text-[#E07B39] text-[14px] text-left text-nowrap top-[94px] tracking-[-0.14px] translate-y-[-50%]">
        <p className="leading-[24px] whitespace-pre">
          <span className="font-['Inter:Bold',_sans-serif] font-bold not-italic text-[#E07B39]">안내: </span>
          <span className="adjustLetterSpacing text-[#757575]">확인 전까지 카드에서 결제되지 않습니다</span>
        </p>
      </div>
    </div>
  );
